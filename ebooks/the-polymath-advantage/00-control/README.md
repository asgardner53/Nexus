...
## Working title
The Polymath Advantage: Why Breadth, Depth and Connection Matter in the Age of AI

Author: Alec Gardner
Publisher: Nexus BMG Pty Ltd
Status: Live ebook development

## Governing thesis
The polymathic advantage is not knowing everything. It is developing the capacity to move responsibly across knowledge boundaries while remaining anchored by depth and disciplined by judgement.

As knowledge expands, specialisation becomes increasingly necessary. Greater specialisation also fragments knowledge. AI expands intellectual access but does not automatically create understanding, competence or judgement. The modern polymathic professional therefore needs enough depth, intellectual range, integration and judgement to recognise relevant expertise, interrogate unfamiliar knowledge, integrate perspectives and know where competence ends.

## Signature concepts
1. Polymathic Capability
2. Epistemic Mobility
3. Polymathic Judgement
4. Collective Polymathy

## Editorial controls
- Australian English.
- Plain English for sophisticated ideas.
- Intelligent readers outside the specific discipline should understand the argument on first read without loss of depth.
- Material factual, empirical, historical, contemporary and contested claims require relevant, verifiable in-text citations.
- Prefer primary studies, official or authoritative sources and high-quality research.
- Harvard AU-style in-text citations and consolidated references.
- Never invent sources, statistics, quotations, cases or dates.
- Distinguish established research from author synthesis.
- Check and report actual word count against chapter target before approval.
- No horizontal rules, divider lines or decorative separators within chapters.
- AI assists. Alec decides.
...
- Metropolitan Museum of Art, Leonardo da Vinci: Master Draftsman, authoritative historical source for Leonardo's drawing, scientific and engineering range.
- Keele, K.D. & Roberts, J. 1983, Leonardo da Vinci: Anatomical Drawings from the Royal Library, Windsor Castle, The Metropolitan Museum of Art.

## Chapter 3 verified evidence anchors
- Boh, W.F., Evaristo, R. & Ouderkirk, A. 2014, 'Balancing breadth and depth of expertise for innovation: A 3M story', Research Policy, vol. 43, no. 2, pp. 349-366, doi:10.1016/j.respol.2013.10.009.
